  ...
  return (
    <div className={cx('deviceList')}>
      <Dropdown
        ...
        disabled={
          !deviceSwitcherState.audioInputDevices || !deviceSwitcherState.audioInputDevices.length
        }
      ...
      <Dropdown
        ...
        disabled={
          !deviceSwitcherState.audioOutputDevices || !deviceSwitcherState.audioOutputDevices.length
        }
        onChange={async (selectedDevice: DeviceType) => {
      ...
      <Dropdown
        ...
        disabled={
          !deviceSwitcherState.videoInputDevices || !deviceSwitcherState.videoInputDevices.length
        }
        onChange={async (selectedDevice: DeviceType) => {
